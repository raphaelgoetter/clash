...
export const CLAN_RESET_TIMES = {
  Y8JUPC9C: { h: 9, m: 42 }, // La Resistance (Clan 1) — reset spécifique 09:42 UTC
  LRQP20V9: { h: 9, m: 45 }, // Les Resistants (Clan 2) — reset spécifique 09:45 UTC
  QU9UQJRL: { h: 9, m: 43 }, // Les Revoltes (Clan 3) — reset spécifique 09:43 UTC
};
